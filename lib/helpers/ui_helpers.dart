...
final class UIHelper {
  ...
  static final double _verticalSpaceExtraMedium = 16.0.w;
  ...
  static Widget horizontalSpaceExtraMedium =
      SizedBox(width: _horizontalSpaceExtraMedium);
  ...
  static Widget horizontalSpaceSemi2Large =
      SizedBox(width: _horizontalSpaceSemi2Large);
  ...
  static Widget customDivider() => Container(
        height: .6.h,
        color: AppColors.c01779D.withOpacity(.3),
